...
/******/ 	return __webpack_require__(__webpack_require__.s = "./modules/block-editor/js/blocks/index.js");
/******/ })
/************************************************************************/
/******/ ({
...
Object(_wordpress_blocks__WEBPACK_IMPORTED_MODULE_6__["registerBlockType"])('polylang/language-switcher', {
	title: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__["__"])('Language switcher', 'polylang-pro'),
	description: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__["__"])('Add a language switcher to allow your visitors to select their preferred language.', 'polylang-pro'),
	icon: 'translation',
	category: 'widgets',
	example: {},
	edit: function edit(props) {
		var createToggleAttribute = function createToggleAttribute(propName) {
			return function () {
				...
				var updatedAttributes = babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0___default()({}, propName, !value);
				var forcedAttributeName = void 0;
				var forcedAttributeUnchecked = void 0;
				...
				if ('show_names' === propName || 'show_flags' === propName) {
					if (value && forcedAttributeUnchecked) {
						updatedAttributes = Object(lodash__WEBPACK_IMPORTED_MODULE_7__["assign"])(updatedAttributes, babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0___default()({}, forcedAttributeName, forcedAttributeUnchecked));
					}
				}
		...
		return wp.element.createElement(
			...
			wp.element.createElement(
				...
				wp.element.createElement(
					...
					{ title: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__["__"])('Language switcher Settings', 'polylang-pro') },
					...
					!dropdown && wp.element.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_4__["ToggleControl"], {
			...
			wp.element.createElement(
				_wordpress_components__WEBPACK_IMPORTED_MODULE_4__["Disabled"],
				null,
				wp.element.createElement(_wordpress_server_side_render__WEBPACK_IMPORTED_MODULE_5___default.a, {
